...
| :--- | :--- | :--- | :--- | :--- |
| `task_list` | **GET** | `/tasks/` | Action list on task. | `(page_size: int | None = None, offset: int | None = None, page: int | None = None, limit: int | None = None, ordering: str | None = None, search: str | None = None)` |
| `task_create` | **POST** | `/tasks/` | Action create on task. | `(title: str, description: str, completed: str | None = None)` |
| `task_completed` | **GET** | `/tasks/completed/` | Action completed on task. | `(page_size: int | None = None, offset: int | None = None, page: int | None = None, limit: int | None = None, ordering: str | None = None, search: str | None = None)` |
